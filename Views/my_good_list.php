...
$params = $creatures->My_good_creatures();
...
<html lang="ja">
  <head>
    ...
    <title>ダイビングリアルタイム生物マップ｜いいね一覧</title>
    <!-- BootstrapのCSS読み込み -->
...
<div class="wrap">
  ...
  <div class="d-flex justify-content-between title">
      <a href="../mypage.php?user_id=<?php echo $user_id ;?>"><i class="fa fa-arrow-left fs-2"></i></a>
      <p class=" fw-bold fs-2 ">いいね一覧</p>
      <div class="ps-4"></div>
  </div>
